...
#     loss_histor.append(epoch_loss)
#     torch.save(model.state_dict(), os.path.join('C:\Users\admin\zz\pythorch\data\catanddog','{0:0=2d}.pth'.format(epoch)))
    
#     print

# time_elapsed = time.time() - since
# print('Training complete in {:.0f}m {:.0f}s'.format(time_elapsed // 60, time_elapsed % 60))
# print('Best Acc: {:4f}'.format
# (best_acc))
